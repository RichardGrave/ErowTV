...
public final class Messages {
	...
	//Server messages
	public final static String EROWTV_IS_ACTIVE = "ErowTV is active";
	public final static String EROWTV_EVENT_REGISTRATION_COMPLETE = "ErowTV event registration complete";
