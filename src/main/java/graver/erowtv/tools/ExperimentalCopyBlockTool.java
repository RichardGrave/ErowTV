...
//                    calculateChunkPositions(player, fileName, directions);
//
...
//
//
//    //TODO:RG Here a runnable that calculates startX, startY and startZ for each Chunk
//
...
//
//                    int calculatedHeight = (height - iterH);
//                    int calculatedWidth = (width - iterW);
//                    int calculatedDepth = (depth - iterD);
//
